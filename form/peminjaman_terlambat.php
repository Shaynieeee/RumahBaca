...
// scope check
if (!isset($scopes) || !in_array('peminjaman-terlambat', $scopes)) {
...
$sql = "SELECT p.id_t_peminjaman, p.tgl_pinjam, p.tgl_kembali, p.status,
        a.no_anggota, a.nama as nama_anggota, a.email, a.id_t_anggota,
        b.nama_buku,
        dp.*, -- ambil seluruh kolom detail pinjam agar tidak memanggil kolom yg tdk ada
...
if (isset($_GET['nonaktif']) && isset($_GET['id_anggota'])) {
    ...
    if (updateStatusAnggota($db, $id_anggota, 'Tidak Aktif', $keterangan)) {
        ...
        echo "<script>alert('Gagal menonaktifkan akun anggota');</script>";
    }
}
?>
                            ...
                            <tbody>
                                ...
                                if ($count > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "</a>";
                                        echo "<br>";
                                        echo "<a href='peminjaman_terlambat.php?nonaktif=1&id_anggota=" . $row['id_t_anggota'] . "' 
                                    ...
                                    echo "<tr><td colspan='10' class='text-center'>Tidak ada data peminjaman yang terlambat</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
