...
// Query statistik jumlah buku yang dipinjam oleh user

// Ambil id_t_account dari user yang login
$sql_account = "SELECT id_t_account FROM t_account WHERE username = '$user_check'";
$result_account = mysqli_query($db, $sql_account);
$row_account = mysqli_fetch_assoc($result_account);
$id_t_account = $row_account['id_t_account'];

// Ambil id_t_anggota dari t_anggota yang terkait dengan akun
$sql_anggota = "SELECT id_t_anggota FROM t_anggota WHERE id_t_account = '$id_t_account'";
$result_anggota = mysqli_query($db, $sql_anggota);
$row_anggota = mysqli_fetch_assoc($result_anggota);
$id_t_anggota = $row_anggota ? $row_anggota['id_t_anggota'] : 0;

// Query statistik jumlah buku yang dipinjam oleh user
$sql_jb = "SELECT COUNT(dp.id_t_detil_pinjam) AS JUMLAH
           FROM t_peminjaman p
           JOIN t_detil_pinjam dp ON p.id_t_peminjaman = dp.id_t_peminjaman
           WHERE p.id_t_anggota = '$id_t_anggota'";
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <span style="color: #a94442;">
                            <strong>Perhatian!</strong> Ada <?php echo $data_terlambat['jum_terlambat']; ?> peminjaman yang
                            belum dikembalikan!
                        </span>
                ...
                <div class="panel-body">
                                        ...
                                        <tr class="<?php echo $row_class; ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if ($row['id_t_account']): ?>
                                                    <a href="#" onclick="kirimNotifikasi(<?php echo $row['id_t_peminjaman']; ?>)"
                    ...
                    <?php else: ?>
                        <div class="alert alert-info">
                            <i class="fa fa-info-circle"></i> Tidak ada peminjaman yang mendekati jatuh tempo dalam 7 hari ke
                            depan.
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background: #0067b0;">
                        <h3 class="panel-title" style="color: #fff;"><i class="fa fa-bar-chart-o fa-fw"></i> Statistik
                            Perpustakaan</h3>
                    </div>
                    <div class="panel-body">
                        <!-- Form Filter -->
