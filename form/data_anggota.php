				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						<select class="form-control" name="txtStatus">
							...
							<option value="Aktif" <?php echo ($selected_status == 'Aktif') ? 'selected' : ''; ?>>Aktif
							</option>
			...
			<table width="100%" class="table table-striped table-bordered table-hover">
				...
				while ($tampil = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					...
					<tr>
						...
						<td><a href="input_anggota.php?id=<?php echo $tampil['id_t_anggota']; ?>"
								class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a></td>
						<td><a href="history_peminjaman.php?id=<?php echo $tampil['id_t_anggota']; ?>"
								class="btn btn-warning btn-sm"><i class="fas fa-history"></i></a></td>
					</tr>
