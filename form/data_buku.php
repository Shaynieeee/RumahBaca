				...
				while ($tampil = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					...
					<tr>
						...
						<td>
							...
							?>
							<img src="<?php echo $gambar_path; ?>" alt="Cover"
						...
						<td>
							<div class="btn-group-action">
								...
								<?php if ($row['id_p_role'] != 3) { ?>
									<a href="input_buku.php?id=<?php echo $tampil['id_t_buku']; ?>"
										class="btn btn-warning btn-sm" title="Edit">
										<i class="fa fa-edit"></i>
									</a>
									<button
										onclick="if(confirm('Apakah anda yakin ingin menghapus data ini?')){ location.href='hapus_buku.php?id=<?php echo $tampil['id_t_buku']; ?>' }"
