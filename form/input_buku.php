					...
					<div class="card-body">
						<form method="post" action="" enctype="multipart/form-data">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php if (!empty($id_buku) && isset($buku['gambar']) && !empty($buku['gambar'])): ?>
											<div class="mt-2">
												<p>Cover saat ini:</p>
												<img src="<?php echo $gambar_path; ?>" alt="Cover Buku"
													class="img-thumbnail" style="max-height: 200px;">
											</div>
										<?php endif; ?>
										<div class="input-group">
											<input type="file" name="gambar" class="form-control" accept="image/*">
											<input type="hidden" name="id_t_buku"
												value="<?php echo $buku['id_t_buku']; ?>">
										</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="number" name="batas_baca_guest" class="form-control" required min="1"
