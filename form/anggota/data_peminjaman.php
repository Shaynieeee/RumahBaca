...
$sql = "SELECT p.*, dp.*, b.nama_buku, 
        ...
        WHERE acc.username = ? 
        AND p.status IN ('Dipinjam', 'Belum Kembali')
...
mysqli_stmt_bind_param($stmt_history, "s", $username);
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-active">
                        ...
                        <tbody>
                            ...
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                ...
                                echo "<td>".date('d-m-Y', strtotime($row['batas_kembali']))."</td>";
                                echo "<td>".$row['qty']."</td>";
                                echo "<td><span class='label label-warning'>Dipinjam</span></td>";
                                echo "</tr>";
                                $no++;
                            }
                            ?>
