...
// Ambil scopes user (digunakan untuk cek akses)
$scopes = [];
...
// Cek akses berdasarkan scope (ganti pemeriksaan role)
    ...
    <div class="book-reader-container">
        ...
        <div class="control-bar">
            ...
            <div class="center-controls">
                <button id="zoomOut" class="btn btn-light" title="Perkecil"
                    style="background: transparent;  border:none; cursor:default;">
                    <!-- <i class="fa fa-search-minus"></i> -->
                </button>
                <button id="zoomIn" class="btn btn-light" title="Perbesar"
                    style="background: transparent;  border:none; cursor:default;">
